...
#define DECLARE_GENERATOR(type, name, params)
    extern ucontext_t name ## _context__; \
...
#define START_GENERATOR(type, name, params)
...
#define EXECUTE_BLOCK(gen, params, type, varname)
    do{
        type* varname = & gen ## _out_var__; \
